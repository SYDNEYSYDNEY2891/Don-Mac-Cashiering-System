...
function crop($filename,$size = 400,$type = 'product')
{
    ...
    //if file to be cropped does not exists
    if(!file_exists($filename))
    {
        if($type == "male")
        {
            return 'assests/images/user_male.jpg';
        } elseif($type == "female"){
            return 'assests/images/user_female.jpg';
        }else{
            return 'assests/images/no_image.jpg';
        }
    ...
    switch ($ext) {
        case 'jpg':
        case 'jpeg':
            imagejpeg($dst_image,$cropped_file,90);            break;
        case 'gif':
            imagegif($dst_image,$cropped_file);            break;
        case 'png':
            imagepng($dst_image,$cropped_file);            break;
        default:
            return $filename;
            break;
    }
